...
public class MemberLevelService {
    ...
    private final OrderConsumptionQueryService orderConsumptionQueryService;

    public MemberLevelService(LoyaltyAccountRepository accountRepository,
                              OrderConsumptionQueryService orderConsumptionQueryService) {
        this.accountRepository = accountRepository;
        this.orderConsumptionQueryService = orderConsumptionQueryService;
    }
    ...
    public MemberLevel evaluateAndUpgrade(Long userId) {
        BigDecimal annual = orderConsumptionQueryService.getAnnualConsumption(userId);
