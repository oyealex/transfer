...
public class SettlementBatchService {
    ...
    public SettlementBatchResponse generateBatch(LocalDate batchDate) {
        ...
        List<PaymentRecord> payments = paymentRecordRepository.findByPaidAtBetween(
                startOfDay, endOfDay).stream()
                .filter(p -> p.getPaidAt() != null)
                .filter(p -> p.getStatus() == com.ecommerce.payment.entity.PaymentStatus.SUCCESS)
        ...
        SettlementBatchResponse response = toBatchResponse(batch);
