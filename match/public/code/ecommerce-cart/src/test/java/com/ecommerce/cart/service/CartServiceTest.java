...
class CartServiceTest {
    ...
    @Test
    @DisplayName("adding same SKU replaces quantity instead of adding")
    void testAddItem_existingSku_replacesQuantity() {
        ...
        // Quantity is REPLACED with 2 instead of ADDED (3+2=5)
    ...
    @Test
    @DisplayName("CartService stores data via JPA CartRepository instead of Caffeine CartCacheManager")
    void testCart_storedInDatabase() {
        ...
        // Verify JPA repositories are used (should use CartCacheManager instead)
