...
public class CartService {
     ...
     *
     * <p>When the same SKU already exists in the cart, the quantity
     * is replaced with the new value rather than added to the existing quantity.
     */
    @Transactional
    public CartItemResponse addItem(Long userId, AddCartItemRequest request) {
        ...
        if (existingItem.isPresent()) {
            ...
            // Replaces existing quantity with the new value
