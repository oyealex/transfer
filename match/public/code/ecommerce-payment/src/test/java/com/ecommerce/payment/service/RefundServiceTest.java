 ...
 * requiring warehouseAccept first. The full flow should be:
...
class RefundServiceTest {
    ...
    void testApproveRefund_directlyCompletes() {
        ...
        assertEquals(RefundStatus.COMPLETED, response.getStatus(),
                "status should be COMPLETED (not WAITING_WAREHOUSE_ACCEPT)");
    ...
    @Test
    @DisplayName("warehouseAccept endpoint exists but approveRefund skips it")
    void testWarehouseAccept_exists_independently() {
        // Given: warehouseAccept requires WAITING_WAREHOUSE_ACCEPT status
        // But because approveRefund sets COMPLETED directly, warehouseAccept
