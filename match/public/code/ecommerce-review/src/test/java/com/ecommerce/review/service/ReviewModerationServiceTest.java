...
/**
 * Unit tests for {@link ReviewModerationService} verifying ACTUAL behavior.
 *
 * <p>{@link #approve(Long, Long, String)} publishes a
 * {@link ReviewApprovedEvent}. Combined with the event already published in
 * {@link ReviewService#createReview}, the user receives review reward points TWICE
 * (40 points instead of 20).
 */
...
class ReviewModerationServiceTest {
    ...
    class ApproveTests {
        ...
        void testApprove_setsStatusApproved_andPublishesEvent() {
            ...
            // is published for this review (first was in ReviewService.createReview).
            // The listener awards 20 points each time → 40 total instead of 20.
