...
/**
 * Unit tests for {@link ReviewApprovedEventListener} verifying ACTUAL behavior.
 *
 ...
 * for a total of 40 instead of the intended 20.
 */
...
class ReviewApprovedEventListenerTest {
    ...
    @Test
    @DisplayName("onReviewApproved: handles multiple events without error (fires twice)")
    void testOnReviewApproved_multipleEvents_noError() {
        // This listener fires TWICE per review — once on submission
