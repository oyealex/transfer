 ...
 *
 * <p>The {@code createShipment} method skips PICKING and LABEL_PRINTED
 * stages and sets the shipment status directly to OUTBOUND.
 */
...
class ShipmentServiceTest {
     ...
     */
    @Test
    void testCreateShipment_skipsToOutbound() {
