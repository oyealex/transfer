...
class LogisticsCallbackServiceTest {
    ...
    /**
     * The callback is logged but the shipment status is NOT updated.
     * Verify that save/update is never called on the ShipmentRepository.
     */
    @Test
    void testProcessCallback_onlyLogs_noDbUpdate() {
