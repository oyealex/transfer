 ...
 *
 * <p>The risk checker itself is correctly implemented, but
 * it is NEVER CALLED in the {@link OrderService#createOrder} flow. The integration
 * test in {@link OrderServiceTest} verifies this omission.
 *
 * <p>These tests verify the risk checker's internal logic works correctly.
 */
