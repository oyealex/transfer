...
class OrderTimeoutServiceTest {
    ...
    @Test
    @DisplayName("timeout cancels order but does NOT release inventory")
    void testTimeout_cancelsOrder_butDoesNotReleaseInventory() {
        // OrderTimeoutService changes status to CANCELLED but
        // does NOT call inventoryReservationService.release().
        // The service does not even HAVE InventoryReservationService as a dependency!
        // Verify the service does NOT have an inventory reservation service field
