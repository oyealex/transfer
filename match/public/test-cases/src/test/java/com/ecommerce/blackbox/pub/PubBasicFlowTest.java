 ...
 * <ul>
 *   <li>pub001 — User auto-activates on registration (PENDING_ACTIVATION vs ACTIVE)</li>
 *   <li>pub003 — Product detail response skuCode may be nested or absent</li>
 *   <li>pub007 — Cart estimate itemTotal calculation differs from expected</li>
 *   <li>pub009 / pub010 — Payment creation and callback may fail due to
 *       missing fields or signature handling</li>
 *   <li>pub011 — Logistics not auto-created after payment callback</li>
 *   <li>pub013 — Invoice creation may fail due to amount validation</li>
 *   <li>pub015 — Sales statistics query returns 0 instead of >= 1</li>
 *   <li>pub016 — Batch order response format differs from expected</li>
 * </ul>
...
class PubBasicFlowTest extends BlackboxTestBase {
    ...
    void pub010_paymentCallbackSuccess() {
        ...
        // Then 2: payment record is retrievable (status may be PENDING if sync post-actions fail)
        assertEquals(200, payQueryResp.getStatusCode().value());
        assertNotNull(apiClient.readJsonPath(payQueryResp, "$.paymentNo"),
                "payment record should be retrievable (status may be PENDING if sync post-actions fail)");
    }
